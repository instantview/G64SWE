...
namespace SpaceTraderApp
{
    ...
    {    
        ...
        {
            using (System.IO.StreamWriter file = new System.IO.StreamWriter(@"..\..\Resources\scores.txt", true))
            {
                string scoreData = string.Format("{0} - {1}", fundsLabel.Text, DateTime.Now.ToString());
        ...
        {
            var highScores = new HighScoresForm();
            highScores.Show();
        }
